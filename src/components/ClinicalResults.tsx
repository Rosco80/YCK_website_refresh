...
export function ClinicalResults({ hideLinks = false }: { hideLinks?: boolean } = {}) {
    ...
    <section className="bg-white py-16 lg:py-32">
      <div className="container mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            <a href={hideLinks ? "#booking-form" : whatsappUrl} target={hideLinks ? "_self" : "_blank"} rel="noopener noreferrer">
              {t("cta")}
