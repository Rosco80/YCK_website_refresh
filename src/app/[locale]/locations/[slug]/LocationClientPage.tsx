            ...
            <div className="grid lg:grid-cols-3 gap-12 items-start">
              <div className="lg:col-span-2 space-y-12">
                  ...
                  <div className="grid md:grid-cols-2 gap-10">
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-label text-brand-teal-deep/60 mb-2">Address</p>
                      ...
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-label text-brand-teal-deep/60 mb-2">Phone</p>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <p className="text-label text-brand-teal-deep/60 mb-2">Operating Hours</p>
                ...
                <div className="pt-8 border-t border-brand-teal/10">
                  <p className="text-label text-brand-teal-deep/60 mb-6">Navigation</p>
              ...
              <aside className="lg:col-span-1">
                <div className="bg-brand-teal/5 rounded-3xl p-8 sticky top-24">
                  ...
                  <p className="text-body text-brand-teal-deep/70 mb-8">Ready to start your recovery? Schedule a professional assessment at our {branchName} clinic today.</p>
                  ...
                  <div className="mt-8 pt-8 border-t border-brand-teal/10 flex items-center space-x-4">
                    ...
                    <p className="text-label text-[10px] text-brand-teal-deep/60">No Referral Needed • KKM Registered</p>
                  </div>
                </div>
              </aside>
            </div>
                ...
                {physios.map((physio, idx) => (
                  ...
                  >
                    ...
                    <div className="text-center md:text-left flex flex-col h-full">
                      ...
                      <p className="text-body text-brand-teal-deep/70 italic mb-8 grow">
                        &quot;{physio.bio}&quot;
                      </p>
